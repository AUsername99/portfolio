...
I've set this page up so everytime I run the [plot_functions.py](Scripts\plot_functions.py), it will fetch a new set of data from the APIs it connects to and refreshes this page and the [Markdown Documents in the Visualisations directories](Decarbonisation\Visualisations\Visualisations.md) which have more details visualisations.
...
Note this does not necessarily mean every kWh you use produces this much CO2, only that on average the UK produces this much per kWh. As you will see further down, it is broken down by area.
...
![Predicted Carbon Intensity Postcode](<Data/Predicted Carbon Intensity Postcode1.png>)

![Predicted Carbon Intensity Postcode](<Data/Predicted Carbon Intensity Postcode2.png>)

This can also be done for an up to (almost) 14 day period as well:

![Predicted Carbon Intensity Postcode2](<Data/Predicted Carbon Intensity Postcode3.png>)
